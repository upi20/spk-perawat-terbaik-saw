    ...
    <div class="card card-primary card-outline">
        <div class="card-header">
            <div class="d-flex justify-content-between w-100">
                <h6 class="card-title">Data {{ $page_attr['title'] }}</h3>
                    <div>
                        <a href="{{ route(h_prefix('format')) }}" class="btn btn-success btn-primary btn-sm"
                            data-toggle="tooltip" title="Formulir Import Data">
                        ...
                        @if ($can_insert)
                            <button type="button" class="btn btn-rounded btn-primary btn-sm" data-bs-effect="effect-scale"
                                data-bs-toggle="modal" href="#modal-default" onclick="addFunc()"
